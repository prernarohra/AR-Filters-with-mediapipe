...
filters_config = {
    ...
    'flower-crown':
        [{'path': "filters/flower-crown.png",
          ...
          'morph': False, 'animated': False, 'has_alpha': True}],
    # 'Green-carnival':
    #     [{'path': "filters/green-carnival.png",
    #       'anno_path': "filters/green-carnival_annotations.csv",
    #       'morph': False, 'animated': False, 'has_alpha': True}],
    'nose-job':
        [{'path': "filters/nose-2.png",
          'anno_path': "filters/labels_my-project-name_2024-11-15-04-30-13.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],
...
while True:
    ...
    if not ret:
        ...
        # cv2.imwrite(output, "outputs/result.png")
